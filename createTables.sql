...
CREATE TABLE Users_jacobc35(username VARCHAR(20) PRIMARY KEY,
                           hashedPassword VARBINARY(256) NOT NULL,
                   balance INT NOT NULL);

CREATE TABLE Reservations_jacobc35(res_id INT PRIMARY KEY,
                                  paid INT NOT NULL,
                                  username VARCHAR(20) NOT NULL REFERENCES Users_jacobc35(username),
